...
- [UI/Logic bug – “Phones” button overrides other category buttons](./bug-reports/jira_bug_logic.png)
- [UI/UX bug – “Buy Now” button not visible/readable on mobile](./bug-reports/jira-bug-faceit-buy-button.png)
- [Mobile bug – Calculator history persists after relaunch](./bug-reports/jira_bug_calculator.png)
